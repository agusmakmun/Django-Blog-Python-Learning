...
class Entry(models.Model):
	...
	domain_post = 'http://python.web.id/blog/'
...
class Gallery(models.Model):
	...
	image_upload = models.ImageField(upload_to='gallery', null=True, blank=True, help_text="Please Choice only One Field, Image or Files")
	file_upload = models.FileField(upload_to='files', null=True, blank=True, help_text="Please Choice only One Field, Image or Files")

	domain = 'http://python.web.id'
...
class Page(models.Model):
	...
	domain_post = 'http://python.web.id/page/'
